...
public class MvcConfig implements WebMvcConfigurer {
	...
	//CommonsMultipartResolver : 파일 업로드를 위한 설정
	@Bean 
	public MultipartResolver multipartResolver() {
		CommonsMultipartResolver mr = new CommonsMultipartResolver();
		mr.setMaxInMemorySize(10485760); //업로드시 메모리 가능 크기 지정 //10메가 까지는 쓰고 10메가 넘으면 파일로 지정해서 쓸거야
	...
	//addInterceptors 쓰려고 implements WebMvcConfigurer 함
	//인터셉터관련 설정
	@Override
