...
public interface UserMapper {
	...
	@Update("update usersecurity set username=#{username},birthday=#{birthday},phoneno=#{phoneno},"
	...
	@Select({"<script>","select ${col} from usersecurity where email=#{email} and phoneno=#{phoneno} "
